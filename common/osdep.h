...
static inline FILE *x264_fopen_internal( const char *filename, const wchar_t *mode_utf16 )
{
    ...
    wchar_t *filename_utf16 = x264_utf8_to_utf16_try_buf( filename, filename_buf, MAX_PATH*4 );
    if( filename_utf16 )
    {
...
{
    int ret = -1;
    wchar_t oldname_buf[MAX_PATH*4];
    wchar_t *oldname_utf16 = x264_utf8_to_utf16_try_buf( oldname, oldname_buf, MAX_PATH*4 );
    if( oldname_utf16 )
    {
        wchar_t newname_buf[MAX_PATH*4];
        wchar_t *newname_utf16 = x264_utf8_to_utf16_try_buf( newname, newname_buf, MAX_PATH*4 );
        if( newname_utf16 )
        {
...
static inline int x264_stat( const char *path, x264_struct_stat *buf )
{
    ...
    wchar_t *path_utf16 = x264_utf8_to_utf16_try_buf( path, path_buf, MAX_PATH*4 );
    if( path_utf16 )
    {
